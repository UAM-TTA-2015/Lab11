...
namespace UamTTA.Tests.Integration
{
    [TestFixture]
    public class RepositoryTests
    {
        ...
        private static Func<UamTTAContext> _dbContextFactory;

        [TestFixtureSetUp]
        public void FixtureSetUp()
        {
            _dbContextFactory = () => new UamTTAContext("IntegrationTestsConnectionString");
            Database.SetInitializer(new DropCreateDatabaseAlways<UamTTAContext>());
